      ...
      <section className="px-6 py-24 bg-surface-container-low rounded-[3rem] mx-4 md:ml-12 md:mr-24 mb-24">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-surface p-10 rounded-[1.5rem] border-none shadow-[0_12px_40px_rgba(41,58,62,0.04)] hover:shadow-[0_12px_40px_rgba(41,58,62,0.12)] transition-shadow">
            ...
            {/* Feature 4 */}
            <div className="bg-surface p-10 rounded-[1.5rem] border-none shadow-[0_12px_40px_rgba(41,58,62,0.04)] hover:shadow-[0_12px_40px_rgba(41,58,62,0.12)] transition-shadow lg:col-span-1">
              <div className="w-14 h-14 rounded-2xl bg-primary-container flex items-center justify-center mb-6 text-primary">
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="bg-gradient-to-br from-primary-fixed to-primary p-10 rounded-[1.5rem] shadow-[0_12px_40px_rgba(41,58,62,0.12)] lg:col-span-2 flex flex-col justify-center relative overflow-hidden">
