  ...
  return (
    <div className="pt-20">
      ...
      <section className="px-6 py-24 bg-surface-container-low rounded-[3rem] mx-4 md:ml-12 md:mr-24 mb-24">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center mb-24">
            <FadeIn delay={0.1} direction="right" className="order-2 md:order-1 space-y-6">
              <h2 className="text-on-surface font-headline text-4xl md:text-5xl font-bold tracking-tighter">
            ...
            <FadeIn delay={0.2} direction="left" className="order-1 md:order-2 bg-primary-container rounded-[2.5rem] h-[400px] flex items-center justify-center p-12 text-center shadow-[0_12px_40px_rgba(41,58,62,0.12)] rotate-1 relative overflow-hidden group">
               <Image 
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <StaggerItem className="bg-surface p-10 rounded-[1.5rem] border-none shadow-[0_12px_40px_rgba(41,58,62,0.04)] hover:shadow-[0_12px_40px_rgba(41,58,62,0.12)] transition-shadow text-center">
              <div className="w-16 h-16 rounded-full bg-primary-container mx-auto flex items-center justify-center mb-6 text-primary">
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="font-headline font-bold text-xl text-on-surface mb-4">Instant Network</h3>
            ...
            <StaggerItem className="bg-surface p-10 rounded-[1.5rem] border-none shadow-[0_12px_40px_rgba(41,58,62,0.04)] hover:shadow-[0_12px_40px_rgba(41,58,62,0.12)] transition-shadow text-center">
              ...
              <h3 className="font-headline font-bold text-xl text-on-surface mb-4">Secure & Private</h3>
              <p className="text-on-surface-variant leading-relaxed font-body text-sm">
            ...
            <StaggerItem className="bg-surface p-10 rounded-[1.5rem] border-none shadow-[0_12px_40px_rgba(41,58,62,0.04)] hover:shadow-[0_12px_40px_rgba(41,58,62,0.12)] transition-shadow text-center">
              ...
              <h3 className="font-headline font-bold text-xl text-on-surface mb-4">Seamless Comms</h3>
              <p className="text-on-surface-variant leading-relaxed font-body text-sm">
      ...
      <section className="py-24 px-6 flex justify-center text-center">
        <FadeIn>
          <h2 className="text-on-surface font-headline text-4xl md:text-5xl font-bold tracking-tighter mb-8 max-w-2xl mx-auto">
            Ready to meet your new housemates?
          </h2>
          <Link href="/book" className="bg-on-background text-surface px-8 py-4 rounded-xl font-headline font-bold text-lg hover:scale-95 duration-150 ease-in-out inline-block border-none">
