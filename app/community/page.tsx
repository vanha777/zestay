...
export default function CommunityPage() {
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="relative px-6 py-24 md:py-32 max-w-[1440px] mx-auto flex flex-col items-center text-center">
      ...
      <section className="px-6 py-24 bg-surface-container-low rounded-[3rem] mx-4 md:ml-12 md:mr-24 mb-24">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center mb-24">
            ...
            <div className="order-1 md:order-2 bg-primary-container rounded-[2.5rem] h-[400px] flex items-center justify-center p-12 text-center shadow-[0_12px_40px_rgba(41,58,62,0.12)] rotate-1 relative overflow-hidden group">
               <Image 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface p-10 rounded-[1.5rem] border-none shadow-[0_12px_40px_rgba(41,58,62,0.04)] hover:shadow-[0_12px_40px_rgba(41,58,62,0.12)] transition-shadow text-center">
